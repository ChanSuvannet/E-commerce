<template>
  <div
    class="filter-container flex flex-col gap-4 bg-gray-50 p-4 rounded-lg shadow-md"
  >
    <!-- Search Bar -->
    <input
      v-model="searchTitle"
    ...
    >
      ...
      <option
        :value="0"
        :class="selectedCategoryId === 0 ? 'bg-red-500 text-white' : ''"
      >
        All Categories
      </option>
      <!-- Other categories -->
      <option
        ...
        :value="category.id"
        :class="
          selectedCategoryId !== 0 && selectedCategoryId === category.id
